  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 shadow-sm border-b border-slate-100 dark:border-gray-800">
      <div className="container mx-auto px-6 h-16 flex justify-between items-center">
        ...
        <button
          type="button"
          className="md:hidden relative z-[60] p-2 text-primary dark:text-white bg-white dark:bg-gray-900 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
