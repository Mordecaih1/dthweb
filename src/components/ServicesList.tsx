...
const services = [
  ...
  },
  {
    ...
    fullDesc: "We provide strategic guidance to help organizations optimize their technology investments and processes. We bridge the gap between business processes and technical solutions.",
          ...
          >
            ...
            >
              ...
              <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto">
                ...
                <h3 className="text-xl font-bold text-primary dark:text-white mb-4 border-b border-slate-100 dark:border-gray-700 pb-2">Key Features</h3>
